...
So as a result, while getting and atrribute message "Emre Bora Kiztan adlı kişinin doğum günü" we cut the sentence with <i>"| replace("adlı kişinin doğum günü", "")"</i> part. This little trick leaves the attribute message as "Emre Bora Kiztan" which is only the name of the person. So if in English it is the as "Birthday of Merve Koç" try the replace line like this, "| replace("Birthday of", "")" this will cut the "Birthday of" sentence and only the name will be displayed.
